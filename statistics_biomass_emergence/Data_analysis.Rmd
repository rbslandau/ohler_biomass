...
```{r, message=FALSE, warning=FALSE}
trait_data <- read.table("/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/stats_trait_data/trait_data.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = TRUE)

trait_data_diff <- read.table("/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/stats_trait_data/trait_data_diff.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = TRUE)

biomass_emergence_family_sample <- read.table("/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/stats_biomass_abundance_data/biomass_emergence_family_sample.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = TRUE)

biomass_emergence_order_sample <- read.table("/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/stats_biomass_abundance_data/biomass_emergence_order_sample.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = TRUE)

biomass_emergence_sample <- read.table("/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/stats_biomass_abundance_data/biomass_emergence_sample.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = TRUE)

data_env_1 <- read.table("/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/stats_land_use_related_drivers_data/data_env_1.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = TRUE)
```
...
load("/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/HGAM_biomass/bio_position_S.RData")
...
load("/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/HGAM_biomass/bio_position_I.RData")
...
load("/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/HGAM_abundance/num_position_S.RData")
...
load("/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/HGAM_abundance/num_position_I.RData")
...
#png(filename="/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/gam_plot_pos.png", width=10, height=5, units="in", res=300)
gam_pos_plot
#dev.off()
```
...
load("/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/HGAM_biomass/bio_position_order_S.RData")
...
load("/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/HGAM_biomass/bio_position_order_I.RData")
...
#png(filename="/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/gam_plot_bio.png", width=10, height=10, units="in", res=300)
plot_bio
#dev.off()
```
...
load("/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/HGAM_abundance/num_position_order_S.RData")
...
load("/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/HGAM_abundance/num_position_order_I.RData")
...
#png(filename="/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/gam_plot_num.png", width=10, height=10, units="in", res=300)
plot_num
#dev.off()
```
...
load("/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/HGAM_biomass/bio_position_family_S.RData")
...
load("/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/HGAM_biomass/bio_position_family_I.RData")
...
#png(filename="/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/gam_plot_bio_Dip.png", width=15, height=20, units="in", res=300)
plot_bio_Dip
#dev.off()
```
##### Plot Fig. S2
...
#png(filename="/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/gam_plot_bio_Eph.png", width=15, height=10, units="in", res=300)
plot_bio_Eph
#dev.off()
```
##### Plot Fig. S3
...
#png(filename="/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/gam_plot_bio_Ple.png", width=10, height=10, units="in", res=300)
plot_bio_Ple
#dev.off()
```
...
#png(filename="/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/gam_plot_bio_Tri.png", width=15, height=25, units="in", res=300)
plot_bio_Tri
#dev.off()
```
#### Get values for paper
...
load("/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/HGAM_abundance/num_position_family_S.RData")
...
load("/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/HGAM_abundance/num_position_family_I.RData")
...
#png(filename="/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/gam_plot_num_Dip.png", width=15, height=20, units="in", res=300)
plot_num_Dip
#dev.off()
```
##### Plot Fig. S6
...
#png(filename="/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/gam_plot_num_Eph.png", width=15, height=10, units="in", res=300)
plot_num_Eph
#dev.off()
```
##### Plot Fig. S7
...
#png(filename="/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/gam_plot_num_Ple.png", width=10, height=10, units="in", res=300)
plot_num_Ple
#dev.off()
```
...
#png(filename="/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/gam_plot_num_Tri.png", width=15, height=25, units="in", res=300)
plot_num_Tri
#dev.off()
```
#### Get values for paper
...
Export data
```{r, message =FALSE, warning= FALSE}
#write.csv(max_pos, file = "/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/max_pos.csv", row.names = FALSE)
#write.csv(max_ord, file = "/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/max_ord.csv", row.names = FALSE)
#write.csv(max_fam, file = "/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/max_fam.csv", row.names = FALSE)
```
...
#write.csv(model_summary, file = "/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/model_summary.csv")
```
## Plots
```{r, message =FALSE, warning= FALSE}
lmm_bio_plot <- ggplot() +
...
Export data
```{r, message =FALSE, warning= FALSE}
#write.csv(model_summary_num, file = "/Users/katharinafrisch/Downloads/ohler_biomass/statistics_biomass_emergence/model_summary_num.csv")
```
## Plots
```{r, message =FALSE, warning= FALSE}
plot_num_fam <- ggplot() +
