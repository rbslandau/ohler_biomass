...
```{r, message=FALSE, warning=FALSE}
trait_data <- read.table("/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/stats_trait_data/trait_data.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = TRUE)

trait_data_diff <- read.table("/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/stats_trait_data/trait_data_diff.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = TRUE)

biomass_emergence_family_sample <- read.table("/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/stats_biomass_abundance_data/biomass_emergence_family_sample.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = TRUE)

biomass_emergence_order_sample <- read.table("/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/stats_biomass_abundance_data/biomass_emergence_order_sample.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = TRUE)

biomass_emergence_sample <- read.table("/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/stats_biomass_abundance_data/biomass_emergence_sample.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = TRUE)

data_env_1 <- read.table("/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/stats_land_use_related_drivers_data/data_env_1.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = TRUE)
```
...
#saveRDS(nmds, file = "/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/nmds.rds")
nmds <- readRDS(file = "/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/ANOSIM/nmds.rds")
```
...
#png(filename="/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/nmds_plot.png", width=5, height=5, units="in", res=300)
nmds_plot
#dev.off()
```
...
load("//Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/HGAM_biomass/bio_position_S.RData")
...
load("/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/HGAM_biomass/bio_position_I.RData")
...
load("/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/HGAM_abundance/num_position_S.RData")
...
load("/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/HGAM_abundance/num_position_I.RData")
...
#png(filename="/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/gam_plot_pos.png", width=10, height=5, units="in", res=300)
gam_pos_plot
#dev.off()


#ggsave(filename = "/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/gam_plot_pos_1.png", gam_pos_plot, width = 10, height = 5, device="png", dpi=300)
```
...
#png(filename="/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/gam_plot_pos_raw.png", width=10, height=10, units="in", res=300)
gam_pos_plot_raw
#dev.off()
```
...
load("/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/HGAM_biomass/bio_position_order_S.RData")
...
load("/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/HGAM_biomass/bio_position_order_I.RData")
...
#png(filename="/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/gam_plot_bio.png", width=10, height=10, units="in", res=300)
plot_bio
#dev.off()
```
...
load("/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/HGAM_abundance/num_position_order_S.RData")
...
load("/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/HGAM_abundance/num_position_order_I.RData")
...
#png(filename="/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/gam_plot_num.png", width=10, height=10, units="in", res=300)
plot_num
#dev.off()
```
...
load("/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/HGAM_biomass/bio_position_family_S.RData")
...
load("/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/HGAM_biomass/bio_position_family_I.RData")
...
#png(filename="/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/gam_plot_bio_Dip.png", width=15, height=20, units="in", res=300)
plot_bio_Dip
#dev.off()
```
...
#png(filename="/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/gam_plot_bio_Eph.png", width=15, height=10, units="in", res=300)
plot_bio_Eph
#dev.off()
```
##### Plot Fig. Plecoptera
...
#png(filename="/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/gam_plot_bio_Ple.png", width=10, height=10, units="in", res=300)
plot_bio_Ple
#dev.off()
```
...
#png(filename="/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/gam_plot_bio_Tri.png", width=15, height=25, units="in", res=300)
plot_bio_Tri
#dev.off()
```
#### Get values for paper
...
load("/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/HGAM_abundance/num_position_family_S.RData")
...
load("/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/HGAM_abundance/num_position_family_I.RData")
...
#png(filename="/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/gam_plot_num_Dip.png", width=15, height=20, units="in", res=300)
plot_num_Dip
#dev.off()
```
##### Plot Fig. Ephemeroptera
...
#png(filename="/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/gam_plot_num_Eph.png", width=15, height=10, units="in", res=300)
plot_num_Eph
#dev.off()
```
##### Plot Fig. Plecoptera
...
#png(filename="/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/gam_plot_num_Ple.png", width=10, height=10, units="in", res=300)
plot_num_Ple
#dev.off()
```
...
#png(filename="/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/gam_plot_num_Tri.png", width=15, height=25, units="in", res=300)
plot_num_Tri
#dev.off()
```
#### Get values for paper
...
Export data
```{r, message =FALSE, warning= FALSE}
#write.csv(max_pos, file = "/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/max_pos.csv", row.names = FALSE)
#write.csv(max_ord, file = "/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/max_ord.csv", row.names = FALSE)
#write.csv(max_fam, file = "/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/max_fam.csv", row.names = FALSE)
```
...
sum(E_bio^2)/(N-p) # 0.42, okay only slight underdispersion
```
...
beta_bio <- beta_bio[c(1,2,7)]

X_bio <- model.matrix(~ max_sumTU_ms_pyr + conductivity , data = data_env_scale) # model matrix LN GLMM, first column only 1 for intercept, other columns fixed effects
...
beta_bio_eph <- beta_bio_eph[c(1)] # remove variables, which are not in final model (=0)

X_bio_eph <- model.matrix(~1, data = data_env_scale) # model matrix LMM, first column only 1 for intercept, other columns fixed effects
...
beta_bio_ple <- beta_bio_ple[c(1,2)] # remove variables, which are not in final model (=0)

X_bio_ple <- model.matrix(~max_sumTU_ms_pyr, data = data_env_scale) # model matrix LMM, first column only 1 for intercept, other columns fixed effects
...
beta_bio_tri <- beta_bio_tri[c(1, 2, 7)]

X_bio_tri <- model.matrix(~max_sumTU_ms_pyr + conductivity, data = data_env_scale) # model LMM, first column only 1 for intercept, other columns fixed effects
...
beta_num <- beta_num[c(1,6,7,8,9)]

X_num <- model.matrix(~pools+conductivity+shading+o2_perc, data = data_env_scale) # model matrix LN GLMM, first column only 1 for intercept, other columns fixed effects
...
beta_num_dip <- beta_num_dip[c(1,6,7,8,9)]

X_num_dip <- model.matrix(~ pools + conductivity+shading+o2_perc, data = data_env_scale) # model matrix LN GLMM, first column only 1 for intercept, other columns fixed effects
...
beta_num_eph <- beta_num_eph[c(1,2)] # remove variables, which are not in final model (=0)

X_num_eph <- model.matrix(~max_sumTU_ms_pyr, data = data_env_scale) # model matrix LMM, first column only 1 for intercept, other columns fixed effects
...
beta_ept <- beta_ept[c(1)]

X_ept <- model.matrix(~ 1, data = data_env_scale) # model matrix LN GLMM, first column only 1 for intercept, other columns fixed effects
...
## Export (G)LMM output
R^2, ICC, sd random factors
```{r, message =FALSE, warning= FALSE}
Model <- c("Total biomass", "Fly biomass", "Mayfly biomass", "Stonefly biomass",
           "Caddisfly biomass", "Total abundance", "Fly abundance", "Mayfly abundance",
           "Stonefly abundance", "Caddisfly abundance","Number EPT families")

sd_stream <- c(lmm_bio_final[["StdDev"]][[1]],
               lmm_bio_dip_final[["StdDev"]][[1]],
               lmm_bio_eph_final[["StdDev"]][[1]],
               lmm_bio_ple_final[["StdDev"]][[1]],
               lmm_bio_tri_final[["StdDev"]][[1]],
               lmm_num_final[["StdDev"]][[1]],
               lmm_num_dip_final[["StdDev"]][[1]],
               lmm_num_eph_final[["StdDev"]][[1]],
               lmm_num_ple_final[["StdDev"]][[1]],
               lmm_num_tri_final[["StdDev"]][[1]],
               glmm_ept_final[["StdDev"]][[1]])

sd_season <- c(lmm_bio_final[["StdDev"]][[2]],
               lmm_bio_dip_final[["StdDev"]][[2]],
               lmm_bio_eph_final[["StdDev"]][[2]],
               lmm_bio_ple_final[["StdDev"]][[2]],
               lmm_bio_tri_final[["StdDev"]][[2]],
               lmm_num_final[["StdDev"]][[2]],
               lmm_num_dip_final[["StdDev"]][[2]],
               lmm_num_eph_final[["StdDev"]][[2]],
               lmm_num_ple_final[["StdDev"]][[2]],
               lmm_num_tri_final[["StdDev"]][[2]],
               glmm_ept_final[["StdDev"]][[2]])

R_mar <- c(R_bio_mar, R_bio_dip_mar, R_bio_eph_mar, R_bio_ple_mar, R_bio_tri_mar,
           R_num_mar, R_num_dip_mar, R_num_eph_mar, R_num_ple_mar, R_num_tri_mar,
           R_ept_mar)

R_con <- c(R_bio_con, R_bio_dip_con, R_bio_eph_con, R_bio_ple_con, R_bio_tri_con,
           R_num_con, R_num_dip_con, R_num_eph_con, R_num_ple_con, R_num_tri_con,
           R_ept_con)
...
R_ICC <- as.data.frame(cbind(Model, R_mar, R_con, ICC_str, ICC_str_adj, ICC_sea, ICC_sea_adj, sd_stream, sd_season))

R_ICC$R_mar <- as.numeric(R_ICC$R_mar)
R_ICC$R_con <- as.numeric(R_ICC$R_con)
R_ICC$ICC_str <- as.numeric(R_ICC$ICC_str)
R_ICC$ICC_str_adj <- as.numeric(R_ICC$ICC_str_adj)
R_ICC$ICC_sea <- as.numeric(R_ICC$ICC_sea)
R_ICC$ICC_sea_adj <- as.numeric(R_ICC$ICC_sea_adj)
R_ICC$sd_stream <- as.numeric(R_ICC$sd_stream)
R_ICC$sd_season <- as.numeric(R_ICC$sd_season)

R_ICC[,2:9] <- round(R_ICC[,2:9], digits = 2)

R_ICC[,2:7] <- R_ICC[,2:7]*100
```

Coefficients, standard errors, z-values
```{r, message =FALSE, warning= FALSE}
coef_bio <- as.data.frame(summary(lmm_bio_final)[["coefficients"]])
coef_bio_dip <- as.data.frame(summary(lmm_bio_dip_final)[["coefficients"]])
coef_bio_eph <- as.data.frame(summary(lmm_bio_eph_final)[["coefficients"]])
coef_bio_ple <- as.data.frame(summary(lmm_bio_ple_final)[["coefficients"]])
coef_bio_tri <- as.data.frame(summary(lmm_bio_tri_final)[["coefficients"]])
  
coef_num <- as.data.frame(summary(lmm_num_final)[["coefficients"]])
coef_num_dip <- as.data.frame(summary(lmm_num_dip_final)[["coefficients"]])
coef_num_eph <- as.data.frame(summary(lmm_num_eph_final)[["coefficients"]])
coef_num_ple <- as.data.frame(summary(lmm_num_ple_final)[["coefficients"]])
coef_num_tri <- as.data.frame(summary(lmm_num_tri_final)[["coefficients"]])

coef_ept <- as.data.frame(summary(glmm_ept_final)[["coefficients"]])

coef <- rbind(coef_bio, coef_bio_dip, coef_bio_eph, coef_bio_ple, coef_bio_tri,
              coef_num, coef_num_dip, coef_num_eph, coef_num_ple, coef_num_tri,
              coef_ept)

Model <- c(rep("Total biomass",9), rep("Fly biomass",9), rep("Mayfly biomass",9),
           rep("Stonefly biomass",9), rep("Caddisfly biomass",9), 
           rep("Total abundance",9),
           rep("Fly abundance",9), rep("Mayfly abundance",9), 
           rep("Stonefly abundance",9),
           rep("Caddisfly abundance",9),rep("Number EPT families",9))

coef$Model <- Model

coef <- filter(coef, Estimate != 0)

coef$Parameter <- rownames(coef)

coef$Parameter <- with(coef, 
              ifelse(Parameter %like% "Intercept", "Intercept",
              ifelse(Parameter %like% "shading", "Shading",
              ifelse(Parameter %like% "conductivity", "EC",
              ifelse(Parameter %like% "max_sumTU_ms_pyr", "Toxicity",
              ifelse(Parameter %like% "pool", "Percentage pool habitats",
              ifelse(Parameter %like% "o2_perc", "Oxygen saturation", "Z")))))))

coef[,1:4] <- round(coef[,1:4], digits = 2)
```

Bind coef and R_ICC
```{r, message =FALSE, warning= FALSE}
model_summary <- left_join(coef, R_ICC, by = "Model")

model_summary <- dplyr::select(model_summary, 
                               c("Model", "Parameter", "Estimate", 
                                       "StdErr", "z.value", "sd_stream",
                                       "sd_season", "R_mar", "R_con",
                                       "ICC_str_adj", "ICC_sea_adj"))
...
#write.csv(model_summary, file = "/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/model_summary.csv")
```
## Plots
```{r, message =FALSE, warning= FALSE}
lmm_bio_plot <- ggplot() +
...
Export data
```{r, message =FALSE, warning= FALSE}
#write.csv(model_summary_num, file = "/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/statistics_biomass_emergence/model_summary_num.csv")
```
## Plots
```{r, message =FALSE, warning= FALSE}
plot_num_fam <- ggplot() +
