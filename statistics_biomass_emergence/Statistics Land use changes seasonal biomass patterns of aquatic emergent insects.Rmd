...
```{r, message=FALSE, warning=FALSE}
trait_data <- read.table("/Users/katharinafrisch/Nextcloud/Land use changes biomass and temporal patterns of insect cross-ecosystem flows/statistics_biomass_emergence/stats_trait_data/trait_data.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = TRUE)

trait_data_diff <- read.table("/Users/katharinafrisch/Nextcloud/Land use changes biomass and temporal patterns of insect cross-ecosystem flows/statistics_biomass_emergence/stats_trait_data/trait_data_diff.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = TRUE)

biomass_emergence_family_sample <- read.table("/Users/katharinafrisch/Nextcloud/Land use changes biomass and temporal patterns of insect cross-ecosystem flows/statistics_biomass_emergence/stats_biomass_abundance_data/biomass_emergence_family_sample.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = TRUE)

biomass_emergence_order_sample <- read.table("/Users/katharinafrisch/Nextcloud/Land use changes biomass and temporal patterns of insect cross-ecosystem flows/statistics_biomass_emergence/stats_biomass_abundance_data/biomass_emergence_order_sample.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = TRUE)

biomass_emergence_sample <- read.table("/Users/katharinafrisch/Nextcloud/Land use changes biomass and temporal patterns of insect cross-ecosystem flows/statistics_biomass_emergence/stats_biomass_abundance_data/biomass_emergence_sample.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = TRUE)

data_env_1 <- read.table("/Users/katharinafrisch/Nextcloud/Land use changes biomass and temporal patterns of insect cross-ecosystem flows/statistics_biomass_emergence/stats_land_use_related_drivers_data/data_env_1.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = TRUE)
```
...
set.seed(222)
anosim <- anosim(spec_ma_site, env_site$stream, distance = "jaccard")
summary(anosim)
plot(anosim)
```
-> restricted permutation because of paired design?
-> no permutations of position within stream, only between streams
-> means dierbach forest can be permuted with kropsbach vine, but not with dierbach forest
...
load("/Users/katharinafrisch/Nextcloud/Land use changes biomass and temporal patterns of insect cross-ecosystem flows/statistics_biomass_emergence/HGAM_biomass/bio_position_S.RData")
...
load("/Users/katharinafrisch/Nextcloud/Land use changes biomass and temporal patterns of insect cross-ecosystem flows/statistics_biomass_emergence/HGAM_biomass/bio_position_I.RData")
...
#### Effect size: Difference between average fit

Use difference between average fit of vine and forest as effect size and calculate its 95 % CI
...
```
Estimate average export per area in whole sampling period
```{r, message=FALSE, warning=FALSE}
export_bio <- ddply(bio_position_S_stat, c("position"), summarise, biomass_area_day_sum = sum(fit, na.rm = TRUE))

export_bio$days <- with(bio_position_S_stat, max(bio_position_S_stat$day) - min(bio_position_S_stat$day))

export_bio$biomass_area_mg <- with(export_bio, biomass_area_day_sum*days)
export_bio$biomass_area_kg <- with(export_bio, round(biomass_area_mg*10^-6, digits = 2))
```
...
load("/Users/katharinafrisch/Nextcloud/Land use changes biomass and temporal patterns of insect cross-ecosystem flows/statistics_biomass_emergence/HGAM_abundance/num_position_S.RData")
...
load("/Users/katharinafrisch/Nextcloud/Land use changes biomass and temporal patterns of insect cross-ecosystem flows/statistics_biomass_emergence/HGAM_abundance/num_position_I.RData")
...
#png(filename="gam_plot_pos.png", width=10, height=5, units="in", res=300)
gam_pos_plot
#dev.off()
```
...
Estimate average export per area in whole sampling period
```{r, message=FALSE, warning=FALSE}
export_num <- ddply(num_position_S_stat, c("position"), summarise, number_area_day_sum = sum(fit, na.rm = TRUE))

export_num$days <- with(bio_position_S_stat, max(num_position_S_stat$day) - min(num_position_S_stat$day))

export_num$number_area <- with(export_num, round(number_area_day_sum*days, digits = 0))
```
...
load("/Users/katharinafrisch/Nextcloud/Land use changes biomass and temporal patterns of insect cross-ecosystem flows/statistics_biomass_emergence/HGAM_biomass/bio_position_order_S.RData")
...
load("/Users/katharinafrisch/Nextcloud/Land use changes biomass and temporal patterns of insect cross-ecosystem flows/statistics_biomass_emergence/HGAM_biomass/bio_position_order_I.RData")
...
#png(filename="gam_plot_bio.png", width=10, height=10, units="in", res=300)
plot_bio
#dev.off()
```
...
load("/Users/katharinafrisch/Nextcloud/Land use changes biomass and temporal patterns of insect cross-ecosystem flows/statistics_biomass_emergence/HGAM_abundance/num_position_order_S.RData")
...
load("/Users/katharinafrisch/Nextcloud/Land use changes biomass and temporal patterns of insect cross-ecosystem flows/statistics_biomass_emergence/HGAM_abundance/num_position_order_I.RData")
...
#png(filename="gam_plot_num.png", width=10, height=10, units="in", res=300)
plot_num
#dev.off()
```
...
load("/Users/katharinafrisch/Nextcloud/Land use changes biomass and temporal patterns of insect cross-ecosystem flows/statistics_biomass_emergence/HGAM_biomass/bio_position_family_S.RData")
...
load("/Users/katharinafrisch/Nextcloud/Land use changes biomass and temporal patterns of insect cross-ecosystem flows/statistics_biomass_emergence/HGAM_biomass/bio_position_family_I.RData")
...
#png(filename="gam_plot_bio_Dip.png", width=15, height=20, units="in", res=300)
plot_bio_Dip
#dev.off()
```
##### Plot Fig. S2
...
#png(filename="gam_plot_bio_Eph.png", width=15, height=10, units="in", res=300)
plot_bio_Eph
#dev.off()
```
##### Plot Fig. S3
...
#png(filename="gam_plot_bio_Ple.png", width=10, height=10, units="in", res=300)
plot_bio_Ple
#dev.off()
```
...
#png(filename="gam_plot_bio_Tri.png", width=15, height=25, units="in", res=300)
plot_bio_Tri
#dev.off()
```
#### Get values for paper
...
load("/Users/katharinafrisch/Nextcloud/Land use changes biomass and temporal patterns of insect cross-ecosystem flows/statistics_biomass_emergence/HGAM_abundance/num_position_family_S.RData")
...
load("/Users/katharinafrisch/Nextcloud/Land use changes biomass and temporal patterns of insect cross-ecosystem flows/statistics_biomass_emergence/HGAM_abundance/num_position_family_I.RData")
...
#png(filename="gam_plot_num_Dip.png", width=15, height=20, units="in", res=300)
plot_num_Dip
#dev.off()
```
##### Plot Fig. S6
...
#png(filename="gam_plot_num_Eph.png", width=15, height=10, units="in", res=300)
plot_num_Eph
#dev.off()
```
##### Plot Fig. S7
...
#png(filename="gam_plot_num_Ple.png", width=10, height=10, units="in", res=300)
plot_num_Ple
#dev.off()
```
...
#png(filename="gam_plot_num_Tri.png", width=15, height=25, units="in", res=300)
plot_num_Tri
#dev.off()
```
#### Get values for paper
...
Export data
```{r, message =FALSE, warning= FALSE}
#write.csv(max_pos, file = "max_pos.csv", row.names = FALSE)
#write.csv(max_ord, file = "max_ord.csv", row.names = FALSE)
#write.csv(max_fam, file = "max_fam.csv", row.names = FALSE)
```
...
sum(E_bio^2)/(N-p) # 0.3 < 0.5 -> slight underdispersion
```
...
#png(filename="lmm_plot.png", width=25, height=15, units="in", res=600)
lmm_plot
#dev.off()
```
...
Export data
```{r, message =FALSE, warning= FALSE}
#write.csv(model_summary_num, file = "model_summary_num.csv")
```
## Plots
```{r, message =FALSE, warning= FALSE}
plot_num_fam <- ggplot() +
...
#png(filename="lmm_plot.png", width=10, height=5, units="in", res=600)
plot_num_fam_ept
#dev.off()
```
