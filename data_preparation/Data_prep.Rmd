...
```{r, message=FALSE, warning=FALSE}
emergence <- read.table("/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/data_preparation/biomass_abundance_data/emergence_identification_92.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = FALSE)
#View(emergence)

emergence_NA_zero <- read.table("/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/data_preparation/biomass_abundance_data/emergence_NA_0_92.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = FALSE)
...
```
Add season
* 18 March - 16 May 2018 as spring
...
```{r, message=FALSE, warning=FALSE}
biomass_emergence <- read.table("/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/data_preparation/biomass_abundance_data/biomass_emergence_93.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = FALSE)

trap_days <- read.table("/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/data_preparation/biomass_abundance_data/no_trap_days.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = FALSE)
```
## Forest and vine
...
```{r, message=FALSE, warning=FALSE}
biomass_emergence_family_sample_num <- reshape2::dcast(biomass_emergence_family_sample, site + stream + position + trap + time + season + collection_days + area_trap ~ ord_fam, value.var="number_sample", fill = 0)

biomass_emergence_family_sample_num <- reshape2::melt(biomass_emergence_family_sample_num, id.vars = c("site", "stream", "position", "trap", "time", "season", "collection_days", "area_trap"))

names(biomass_emergence_family_sample_num)[9:10] <- c("ord_fam", "number_sample")

biomass_emergence_family_sample_bio <- reshape2::dcast(biomass_emergence_family_sample, site + stream + position + trap + time + season + collection_days + area_trap ~ ord_fam, value.var="biomass_sample", fill = 0)

biomass_emergence_family_sample_bio <- reshape2::melt(biomass_emergence_family_sample_bio, id.vars = c("site", "stream", "position", "trap", "time", "season", "collection_days", "area_trap"))
...
Fill with zero, because some orders not found in every sample and thus their number/weight is 0 in this sample
```{r, message=FALSE, warning=FALSE}
biomass_emergence_order_sample_num <- reshape2::dcast(biomass_emergence_order_sample, site + stream + position + trap + time + season + collection_days + area_trap ~ order, value.var="number_sample", fill = 0)

biomass_emergence_order_sample_num <- reshape2::melt(biomass_emergence_order_sample_num, id.vars = c("site", "stream", "position", "trap", "time", "season", "collection_days", "area_trap"))

names(biomass_emergence_order_sample_num)[9:10] <- c("order", "number_sample")

biomass_emergence_order_sample_bio <- reshape2::dcast(biomass_emergence_order_sample, site + stream + position + trap + time + season + collection_days + area_trap ~ order, value.var="biomass_sample", fill = 0)

biomass_emergence_order_sample_bio <- reshape2::melt(biomass_emergence_order_sample_bio, id.vars = c("site", "stream", "position", "trap", "time", "season", "collection_days", "area_trap"))
...
emergence_NA_zero <- read.table("/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/data_preparation/biomass_abundance_data/no_trap_days_NA.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = FALSE)
```
Adjust column names
```{r, message=FALSE, warning=FALSE}
...
Load data
```{r, message=FALSE, warning=FALSE}
generation_time <- read.table("/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/data_preparation/trait_data/generation_time_spear.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = TRUE)

Trait_EU <- readRDS(file = "/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/data_preparation/trait_data/Trait_DB_EU_corrected.rds")
```
## Size
...
size_bio_sample <- reshape2::melt(size_bio_sample, id.vars = c("site", "stream", "position", "trap", "time"))
```
...
size_bio_diff_1 <-  reshape2::dcast(size_bio_diff, stream + class ~ position, value.var="bio_size_ratio")
...
size_bio_diff <-  reshape2::dcast(size_bio_diff, stream + class ~ position, value.var="bio_size")
...
#png(filename="/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/data_preparation/diff_size_rat_class.png", width=15, height=10, units="in", res=300)
diff_size_rat
#dev.off()
```
...
gen_bio_diff_1 <-  reshape2::dcast(gen_bio_diff, stream + generation_sensitive ~ position, value.var="bio_gen_ratio")
...
gen_bio_diff <-  reshape2::dcast(gen_bio_diff, stream + generation_sensitive ~ position, value.var="bio_gen")
...
#png(filename="/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/data_preparation/diff_gen_rat.png", width=5, height=5, units="in", res=300)
diff_sen_rat
#dev.off()
```
...
```{r, message=FALSE, warning=FALSE}
bio_gen_wide <- reshape2::dcast(bio_gen, stream + position ~ generation_sensitive, value.var = c("bio_gen_ratio"))

bio_size_wide <- reshape2::dcast(bio_size, stream + position ~ class, value.var = c("bio_size_ratio"))
```
Unit tables
```{r, message=FALSE, warning=FALSE}
bio_gen_wide <- reshape2::dcast(bio_gen, stream + position ~ generation_sensitive, value.var = c("bio_gen_ratio"))
...
## Load data
```{r, message=FALSE, warning=FALSE}
phys_chem <- read.table("/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/data_preparation/land_use_related_drivers_data/phys_chem.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = FALSE)
#View(phys_chem)
```
...
phys_chem$season <-with(phys_chem, ifelse(time > "2018-03-17" & time <= "2018-05-16","spring",ifelse(time > "2018-05-16" & time <= "2018-07-26","summer","autumn")))
...
# Habitat parameter
```{r, message=FALSE, warning=FALSE}
habitat <- read.table("/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/data_preparation/land_use_related_drivers_data/habitat.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = FALSE)
```
## Correct mistakes in raw data and convert it into right form
Correct wrong date
```{r, message=FALSE, warning=FALSE}
...
habitat$season <-with(habitat, ifelse(time > "2018-03-17" & time <= "2018-05-16","spring",ifelse(time > "2018-05-16" & time <= "2018-07-26","summer","autumn")))
...
```{r, message=FALSE, warning=FALSE}
psm_conc <- read.table("/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/data_preparation/pesticide_data/3_ANA_ConcentrationTox.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = FALSE)
```
...
Load samples 
```{r, message=FALSE, warning=FALSE}
psm_forest <- read.table("/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/data_preparation/pesticide_data/samples_forest_2.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = FALSE)
```
Long format and name columns
```{r, message=FALSE, warning=FALSE}
psm_forest <- reshape2::melt(psm_forest, 
...
```{r}
CAS_KgM <- read.table("/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/data_preparation/pesticide_data/0_ANA_Substances.txt", header = TRUE,sep = "\t", na.strings = c("NR", "NA")) 
```
Merge tables
```{r}
...
```{r, message=FALSE, warning=FALSE}
psm_conc_RP$season <-with(psm_conc_RP, ifelse(Date > "2018-03-17" & Date <= "2018-05-16","spring",ifelse(Date > "2018-05-16" & Date <= "2018-07-26","summer","autumn")))
...
```{r, message=FALSE, warning=FALSE}
no_psm_type_long <- reshape2::melt(no_psm_type, id.vars=c("samplingID"))
```
...
transform to long
```{r, message=FALSE, warning=FALSE}
no_psm_type2_long <- reshape2::melt(no_psm_type2, id.vars=c("samplingID"))
```
violinplot
```{r, message=FALSE, warning=FALSE}
...
transform to long
```{r, message=FALSE, warning=FALSE}
no_psm_type3_long <- reshape2::melt(no_psm_type3, id.vars=c("samplingID"))
```
violinplot
```{r, message=FALSE, warning=FALSE}
...
You need to replace this line with a path on your computer
```{r, message=FALSE, warning=FALSE}
sed_conc <- read.table("/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/data_preparation/pesticide_data/20191111_KgM_SPM-Extrakte_2018_final_nur_RLP.csv", header = TRUE, sep = ",", na.strings = c("NR", "NA"), stringsAsFactors = FALSE)
# View(sed_conc)

foc <- read.table("/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/data_preparation/pesticide_data/06_Schwebstoffilter GC_LC.csv", header = TRUE, sep = ",", na.strings = c("NR", "NA"), stringsAsFactors = FALSE)
# View(foc)
```
...
```{r, message=FALSE, warning=FALSE}
psm_sed_conc$season <-with(psm_sed_conc, ifelse(Date > "2018-03-17" & Date <= "2018-05-16","spring",ifelse(Date > "2018-05-16" & Date <= "2018-07-26","summer","autumn")))
...
if (run) {
  ...
  query_st = readRDS(file = "/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/data_preparation/pesticide_data/KGM_freshwater_invertebrate_XX50.rds")
}
...
```{r, message=FALSE, warning=FALSE}
EC50_manually <- read.table("/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/data_preparation/pesticide_data/EC50_version_190326.csv", header = TRUE, sep = ",", na.strings = c("NR", "NA"), stringsAsFactors = FALSE)
...
Prepare data
```{r, message =FALSE, warning= FALSE}
sumTU_plot <- reshape2::melt(max_sumTU_date, id=c( "Site", "stream", "position", "season", "Date", "day"))
max_TU_plot <- reshape2::melt(maxTU_date, id=c("Site", "stream", "position", "season", "Date", "day"))
...
#png(filename="/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/data_preparation/max_TU_sumTU.png", width=7.5, height=7.5, units="in", res=300)
max_TU_sumTU
#dev.off()
```
...
diff <- reshape2::melt(diff, id=c( "Site", "stream", "position", "season"))
...
#png(filename="/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/data_preparation/diff_plot.png", width=20, height=10, units="in", res=300)
plot_diff
#dev.off()
```
...
#png(filename="/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/data_preparation/diff_fam_ept.png", width=10, height=10, units="in", res=300)
plot_diff_fam_ept
#dev.off()
```
...
range_env_all <- reshape2::melt(range_env_all, id.vars=c("Site", "stream", "position","season"))
str(range_env_all)
...
range_env_all <- reshape2::dcast(range_env_all, variable + Unit ~ position, value.var="mean_range")
...
#write.csv(range_env_all, file = "/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/data_preparation/range_env_all.csv", row.names = FALSE)
#write.csv(range_env_glmm, file = "/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/data_preparation/range_env_glmm.csv", row.names = FALSE)
```

# Save data for statistics
## HGAM
```{r, message =FALSE, warning= FALSE}
#write.csv(biomass_emergence_sample, file = "/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/data_preparation/biomass_emergence_sample.csv", row.names = FALSE)

#write.csv(biomass_emergence_order_sample, file = "/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/data_preparation/biomass_emergence_order_sample.csv", row.names = FALSE)

#write.csv(biomass_emergence_family_sample, file = "/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/data_preparation/biomass_emergence_family_sample.csv", row.names = FALSE)
```
## (G)LMM
```{r, message =FALSE, warning= FALSE}
#write.csv(data_env_1, file = "/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/data_preparation/data_env_1.csv", row.names = FALSE)

#write.csv(data_env, file = "/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/data_preparation/data_env.csv", row.names = FALSE)
```
## Paired t-test
```{r, message =FALSE, warning= FALSE}
#write.csv(trait_data, file = "/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/data_preparation/trait_data.csv", row.names = FALSE)
#write.csv(trait_data_diff, file = "/Users/katharinafrisch/Documents/Uni/Paper/Biomass Paper/GCB_submission/4_new_mixed_models/ohler_biomass/data_preparation/trait_data_diff.csv", row.names = FALSE)
```