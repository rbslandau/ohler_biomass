...
```{r, message=FALSE, warning=FALSE}
emergence <- read.table("/Users/katharinafrisch/Downloads/ohler_biomass/data_preparation/biomass_abundance_data/emergence_identification_92.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = FALSE)
#View(emergence)

emergence_NA_zero <- read.table("/Users/katharinafrisch/Downloads/ohler_biomass/data_preparation/biomass_abundance_data/emergence_NA_0_92.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = FALSE)
...
```{r, message=FALSE, warning=FALSE}
biomass_emergence <- read.table("/Users/katharinafrisch/Downloads/ohler_biomass/data_preparation/biomass_abundance_data/biomass_emergence_93.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = FALSE)

trap_days <- read.table("/Users/katharinafrisch/Downloads/ohler_biomass/data_preparation/biomass_abundance_data/no_trap_days.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = FALSE)
```
## Forest and vine
...
emergence_NA_zero <- read.table("/Users/katharinafrisch/Downloads/ohler_biomass/data_preparation/biomass_abundance_data/no_trap_days_NA.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = FALSE)
```
Adjust column names
```{r, message=FALSE, warning=FALSE}
...
Load data
```{r, message=FALSE, warning=FALSE}
generation_time <- read.table("/Users/katharinafrisch/Downloads/ohler_biomass/data_preparation/trait_data/generation_time_spear.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = TRUE)

Trait_EU <- readRDS(file = "/Users/katharinafrisch/Downloads/ohler_biomass/data_preparation/trait_data/Trait_DB_EU_corrected.rds")
```
## Size
...
#png(filename="/Users/katharinafrisch/Downloads/ohler_biomass/data_preparation/diff_size_rat_class.png", width=15, height=10, units="in", res=300)
diff_size_rat
#dev.off()
```
...
#png(filename="/Users/katharinafrisch/Downloads/ohler_biomass/data_preparation/diff_gen_rat.png", width=5, height=5, units="in", res=300)
diff_sen_rat
#dev.off()
```
...
## Load data
```{r, message=FALSE, warning=FALSE}
phys_chem <- read.table("/Users/katharinafrisch/Downloads/ohler_biomass/data_preparation/land_use_related_drivers_data/phys_chem.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = FALSE)
#View(phys_chem)
```
...
# Habitat parameter
```{r, message=FALSE, warning=FALSE}
habitat <- read.table("/Users/katharinafrisch/Downloads/ohler_biomass/data_preparation/land_use_related_drivers_data/habitat.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = FALSE)
```
## Correct mistakes in raw data and convert it into right form
Correct wrong date
```{r, message=FALSE, warning=FALSE}
...
```{r, message=FALSE, warning=FALSE}
psm_conc <- read.table("/Users/katharinafrisch/Downloads/ohler_biomass/data_preparation/pesticide_data/3_ANA_ConcentrationTox.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = FALSE)
```
...
Load samples 
```{r, message=FALSE, warning=FALSE}
psm_forest <- read.table("/Users/katharinafrisch/Downloads/ohler_biomass/data_preparation/pesticide_data/samples_forest_2.csv", header = TRUE, sep = ",",na.strings = c("NR", "NA"), stringsAsFactors = FALSE)
```
...
```{r}
CAS_KgM <- read.table("/Users/katharinafrisch/Downloads/ohler_biomass/data_preparation/pesticide_data/0_ANA_Substances.txt", header = TRUE,sep = "\t", na.strings = c("NR", "NA")) 
```
Merge tables
```{r}
...
You need to replace this line with a path on your computer
```{r, message=FALSE, warning=FALSE}
sed_conc <- read.table("/Users/katharinafrisch/Downloads/ohler_biomass/data_preparation/pesticide_data/20191111_KgM_SPM-Extrakte_2018_final_nur_RLP.csv", header = TRUE, sep = ",", na.strings = c("NR", "NA"), stringsAsFactors = FALSE)
# View(sed_conc)

foc <- read.table("/Users/katharinafrisch/Downloads/ohler_biomass/data_preparation/pesticide_data/06_Schwebstoffilter GC_LC.csv", header = TRUE, sep = ",", na.strings = c("NR", "NA"), stringsAsFactors = FALSE)
# View(foc)
```
...
if (run) {
  ...
  query_st = readRDS(file = "/Users/katharinafrisch/Downloads/ohler_biomass/data_preparation/pesticide_data/KGM_freshwater_invertebrate_XX50.rds")
}
...
```{r, message=FALSE, warning=FALSE}
EC50_manually <- read.table("/Users/katharinafrisch/Downloads/ohler_biomass/data_preparation/pesticide_data/EC50_version_190326.csv", header = TRUE, sep = ",", na.strings = c("NR", "NA"), stringsAsFactors = FALSE)
...
#png(filename="/Users/katharinafrisch/Downloads/ohler_biomass/data_preparation/max_TU_sumTU.png", width=7.5, height=7.5, units="in", res=300)
max_TU_sumTU
#dev.off()
```
...
#png(filename="/Users/katharinafrisch/Downloads/ohler_biomass/data_preparation/diff_plot.png", width=20, height=10, units="in", res=300)
plot_diff
#dev.off()
```
...
#png(filename="/Users/katharinafrisch/Downloads/ohler_biomass/data_preparation/diff_fam_ept.png", width=10, height=10, units="in", res=300)
plot_diff_fam_ept
#dev.off()
```
...
#write.csv(range_env_all, file = "/Users/katharinafrisch/Downloads/ohler_biomass/data_preparation/range_env_all.csv", row.names = FALSE)
#write.csv(range_env_glmm, file = "/Users/katharinafrisch/Downloads/ohler_biomass/data_preparation/range_env_glmm.csv", row.names = FALSE)
```

# Save data for statistics
## HGAM
```{r, message =FALSE, warning= FALSE}
#write.csv(biomass_emergence_sample, file = "/Users/katharinafrisch/Downloads/ohler_biomass/data_preparation/biomass_emergence_sample.csv", row.names = FALSE)

#write.csv(biomass_emergence_order_sample, file = "/Users/katharinafrisch/Downloads/ohler_biomass/data_preparation/biomass_emergence_order_sample.csv", row.names = FALSE)

#write.csv(biomass_emergence_family_sample, file = "/Users/katharinafrisch/Downloads/ohler_biomass/data_preparation/biomass_emergence_family_sample.csv", row.names = FALSE)
```
## (G)LMM
```{r, message =FALSE, warning= FALSE}
#write.csv(data_env_1, file = "/Users/katharinafrisch/Downloads/ohler_biomass/data_preparation/data_env_1.csv", row.names = FALSE)
```
## Paired t-test
```{r, message =FALSE, warning= FALSE}
#write.csv(trait_data, file = "/Users/katharinafrisch/Downloads/ohler_biomass/data_preparation/trait_data.csv", row.names = FALSE)
#write.csv(trait_data_diff, file = "/Users/katharinafrisch/Downloads/ohler_biomass/data_preparation/trait_data_diff.csv", row.names = FALSE)
```